...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { date: @attendance.date, student_id: @attendance.student_id, type: @attendance.type }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { date: @attendance.date, student_id: @attendance.student_id, type: @attendance.type }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
